...
//    P1SEL &= ~(0x08);//BIT3;           // Function as General Purpose I/O.
//    P1_3 = 1;                 // LED1 on.
//    P1DIR |= 0x08;//BIT3;            // Output.
//
    P1SEL &= ~(0x10);//BIT3;           // Function as General Purpose I/O.
    P1_4 = 0;                 // LED1 on.
    P1DIR |= 0x10;//BIT3;            // Output.
//my_delay_ms(100);
//    static char hello[]="hello wprld \n";
//    while (sendDataToHost(hello, strlen(hello)));
smg_init();
    I2CWC |=0x83;//I2C gpio¿ÚÓÃ
    char dis[3]={1,2,3};
  // smg_display(dis);
  /* Start OSAL */
